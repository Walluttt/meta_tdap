using JuMP, Gurobi, Printf, TexTables,DataFrames
...
function model_moa_2015(filename)  
...
if (all) 
    ...
    if (table)
        ...
        #savefig(graph_bi(info,"model_bi_2015"),"../../fig/model_bi_2015.png")
