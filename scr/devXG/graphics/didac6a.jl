...
elseif m==4
    ...
    c = [0.0 10.0 20.0 10.0; 
         ...
         10.0 20.0 10.0 0.0]
    # operational time for pallets from dock k to dock l  (in minutes, 0<=minutes<=59)
    t = [0.002    0.00475  0.01275  0.01;
    0.00475  0.002    0.01     0.01275;
    0.01275  0.01     0.002    0.00475;
    0.01     0.01275  0.00475  0.002]

    #=
    t = [0.00 0.10 0.18 0.10; 
         0.10 0.00 0.10 0.18; 
         0.18 0.10 0.00 0.10;
         0.10 0.18 0.10 0.00 ]
         =#
...
#=
p = [ 00 100 100 100  00 00;
      00  00 100 100 100 00;
      00  00  00  00  00 00;
      100 00  00  00  00 00;
...
#=
f = [ 00 00 00 00 00 00;  #2 seul camion livreur
      00 00 00 00 00 00;
      00 00 00 00 00 00;
      00 00 00 00 00 00;
      01 02 03 04 00 00;
...
@png begin
    ...
    for i in 1:Int(nbrQuai/2)
        ...
        sethue("white")
        label = string(i)
        Luxor.textcentered(label, -245+i*55+8*echelle, -97)
        label = string(nbrQuai-i+1)
        Luxor.textcentered(label, -245+i*55+8*echelle, 103)
    end 
